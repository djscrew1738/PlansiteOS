...
### Network Access (LAN)
- **Frontend**: http://192.168.1.215:3000
- **Backend API**: http://192.168.1.215:5000
- **Health Check**: http://192.168.1.215:5000/api/health

### Tailscale Access
- **Frontend**: http://100.109.158.92:3000
- **Backend API**: http://100.109.158.92:5000
- **Health Check**: http://100.109.158.92:5000/api/health
...
# CORS
CORS_ORIGIN=http://localhost:3000,http://192.168.1.215:3000,...
...
```bash
VITE_API_URL=http://192.168.1.215:5000
```
...
### "Port already in use"
The setup script automatically kills processes on ports 5000 and 3000.
Or manually:
```bash
...
- Tailscale: http://100.109.158.92:3000
...
**Built with ❤️ for cbrnholdings.com**
**Version**: 1.0.0
**Last Updated**: January 20, 2026
